...
const VideoPlayer = () => {
    ...
    console.log('skipIntoStatus', resolutionSrc)
    return (
                        ...
                        <div className='d-flex justify-content-center align-items-center main-section'>
                            <div className='video-player-box' onMouseOver={mouserOver}>
                                ...
                                <Player
                                    ...
                                    startTime={resolutionSrc ? parseInt(currentTime) : skipIntroStatus === "false" ? 0 : updateStartData === false ? timeAfterAds : currentTime}
